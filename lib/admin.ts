...
export const adminNav: AdminNavItem[] = [
  {
    ...
    description: "Overview of activity across the restaurant.",
  },
  {
    href: "/admin/bookings",
    label: "Bookings",
    icon: CalendarDays,
    description: "Reservation requests to review, plus every table and event.",
  },
  {
    href: "/admin/calendar",
    label: "Calendar",
    icon: CalendarRange,
    description: "Month view across sittings, with closure dates.",
  },
  {
    href: "/admin/guests",
    label: "Guests",
    icon: Users,
    description: "Everyone who has booked or asked to, with notes.",
  },
  {
  ...
  },
  {
    ...
    label: "Spaces",
    icon: Home,
    description: "The dining room, the counter and private hire.",
  },
  {
    href: "/admin/gallery",
    label: "Gallery",
    icon: ImageIcon,
    description: "Photography shown on the public site.",
  },
  {
    href: "/admin/settings",
    label: "Settings",
